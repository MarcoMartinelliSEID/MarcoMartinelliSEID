...
from ZohoCreator import token_API, zoho_API
...
def zohoCreatorGUI(token):
    ...
    label_job1 = Label(GUI, text = "", font = font2, width = 100, height = 4, wraplength=700, borderwidth=2, relief="flat", fg = "yellow", background = "#404040")
    label_job2 = Label(GUI, text = "", font = font2, width = 100, height = 4, wraplength=700, borderwidth=2, relief="flat", fg = "white", background = "#404040")
    label_job3 = Label(GUI, text = "", font = font2, width = 100, height = 4, wraplength=700, borderwidth=2, relief="flat", fg = "white", background = "#404040")
    label_job4 = Label(GUI, text = "", font = font2, width = 100, height = 4, wraplength=700, borderwidth=2, relief="flat", fg = "white", background = "#404040")
    label_job5 = Label(GUI, text = "", font = font2, width = 100, height = 4, wraplength=700, borderwidth=2, relief="flat", fg = "white", background = "#404040")
